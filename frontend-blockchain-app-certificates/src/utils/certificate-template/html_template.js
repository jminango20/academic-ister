...
const html_course_template_certificate = `
<!DOCTYPE html>
...
const html_project_template_certificate = `
<!DOCTYPE html>
<html style="-webkit-print-color-adjust: exact; margin: 0">
<head>
    <title>{{web-title}}</title>
...
export  {html_course_template_certificate, html_project_template_certificate};